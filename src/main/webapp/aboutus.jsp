...
OLX is the world's leading classifieds platform which provides local communities in high-growth markets with vibrant online marketplaces: OLX connects local people to buy,
 sell or exchange used goods and services by making it fast and easy for anyone to post a listing through their mobile phone or on the web.

Every month, hundreds of millions of people in local markets around the world are already using OLX's online marketplace to find and sell a wide range of products, 
including computers, cell phones, furniture, used cars, properties, and many more.
</div>
			...
			<div class="container">
				...
				<div class="col-md-3 wthree-footer-grid">
							...
							<ul>
								...
								<li><a href="faqs"><i class="fa fa-long-arrow-right"></i>FAQs</a></li>
