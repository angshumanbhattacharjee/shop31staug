			...
			<div class="w3-categories">
				...
				<div class="container">
					...
					<div class="col-md-3">
						...
						<a class="btn-8" href="categories#parentVerticalTab2">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="focus-grid w3layouts-boder3">
						<a class="btn-8" href="categories#parentVerticalTab3">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="focus-grid w3layouts-boder4">
						<a class="btn-8" href="categories#parentVerticalTab4">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="focus-grid w3layouts-boder5">
						<a class="btn-8" href="categories#parentVerticalTab5">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="focus-grid w3layouts-boder6">
						<a class="btn-8" href="categories#parentVerticalTab6">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="focus-grid w3layouts-boder7">
						<a class="btn-8" href="categories#parentVerticalTab7">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="focus-grid w3layouts-boder8">
						<a class="btn-8" href="categories#parentVerticalTab8">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="focus-grid w3layouts-boder9">
						<a class="btn-8" href="categories#parentVerticalTab9">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="focus-grid w3layouts-boder10">
						<a class="btn-8" href="categories#parentVerticalTab10">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="focus-grid w3layouts-boder11">
						<a class="btn-8" href="categories#parentVerticalTab11">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="focus-grid w3layouts-boder12">
						<a class="btn-8" href="categories#parentVerticalTab12">
							<div class="focus-border">
								<div class="focus-layout">
				 ...
				 <div class="w3l-popular-ads-info">
					<div class="col-md-4 w3ls-portfolio-left">
						...
						<div class="portfolio-description">
						   <h4><a href="cars">Latest Cars</a></h4>
					...
					<div class="col-md-4 w3ls-portfolio-left">
						...
						<div class="portfolio-description">
						   <h4><a href="real-estate">Apartments for Sale</a></h4>
						   <p>Suspendisse placerat mattis arcu nec por</p>
							<a href="real-estate">
								<span>Explore</span>
							</a>
					...
					<div class="col-md-4 w3ls-portfolio-left">
						...
						<div class="portfolio-description">
						   <h4><a href="electronics-appliances">Accessories</a></h4>
						   <p>Suspendisse placerat mattis arcu nec por</p>
							<a href="electronics-appliances">
								<span>Explore</span>
							</a>
						</div>
						<div class="clearfix"> </div>
					...
					<div class="col-md-4 w3ls-portfolio-left">
						...
						<div class="portfolio-description">
						   <h4><a href="furnitures">Home Appliances</a></h4>
						   <p>Suspendisse placerat mattis arcu nec por</p>
							<a href="furnitures">
								<span>Explore</span>
							</a>
					...
					<div class="col-md-4 w3ls-portfolio-left">
						...
						<div class="portfolio-description">
						   <h4><a href="fashion">Clothing</a></h4>
						   <p>Suspendisse placerat mattis arcu nec por</p>
							<a href="fashion">
								<span>Explore</span>
							</a>
			...
			<div class="agile-info-mobile-app">
				<div class="container">
					<div class="col-md-5 w3-app-left">
						<a href="mobileapp"><img src="images/app.png" alt=""></a>
					</div>
